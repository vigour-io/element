'use strict'
var arraylike = require('vigour-js/lib/util/is/arraylike')
...
exports.test = test = function (_ua, fn) {
  for (var tests = arraylike(arguments, 1), i = tests.length - 1, query = tests[i][0]; query !== true && !new RegExp(query).test(_ua); query = tests[--i][0]) {
