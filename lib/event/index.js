            ...
            global.addEventListener(val, function (e) {
              ...
              while (parentNode) {
                if (parentNode.dirty) {
                  ...
                  // get rendered with godamn hashpath super nice -- add hashes
                  // MAN SO GOOD
                  ...
                  for (let i = 0, length = path.length, walk = global.engine; i < length; i++) {
                    let lwalk = walk
