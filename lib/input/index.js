...
var Input = new Element({
  ...
  $flags:{
    ...
    $verify:function( fn ) {
     ...
     /**
     * Use the defaultError flag to use the default style for erros on the input validation
     * @type {object}
     * @param {function} fn - The function that will be used by the transform to perform the validation
     * @memberOf Component.Input
     */
    ...
    /**
     * Use the errorStyle property is created when the defaultError flag is used.
     * It is an instance of a new Observable Object, and change the input border color, when the validation fails.
     *
     * @type {object}
     * @memberOf Component.Input
     *
     ...
     * })
     *
     *  Note: When defatulError is true, it uses the verify logic to decide if the input is valid or not.
     *
     */
