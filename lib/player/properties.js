...
Property = new Property({
  define: {
    compare (property, data, props, children, current, prev) {
      ...
      currentState(key, current, prev)
      console.log(' ------> ', stamp, current.state.data)
...
exports.define = {
  ...
  initialised: {
    ...
    get () {
      return this.state && this.state.props && this.state.props.initialised
    }
  },
  instance: {
    set (val) {
    ...
    get () {
      return this.state && this.state.props && this.state.props.instance
    }
  },
  setTime: {
    set (val) {
