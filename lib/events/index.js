...
/**
 * The findTarget function, tries to discover the closest instance of $base on the Dom tree starting 
 * from the own element
 * @param  {object} node The dom node for the element
 * @return {Object} target The target for the object on the Tom tree
 *
 * @example
 *
 * var a = new Element({
 ...
 * })
 *
 * When elementB is clicked, the findTargetFunction will try to discover correct target. This way 
