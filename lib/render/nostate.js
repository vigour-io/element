'use strict'
exports.property = function (target, type, stamp, subs, tree, ptree, div) {
  ...
  if (nostatesproperties) {
    for (let i in nostatesproperties) {
      ...
      iteratee
        .render(void 0, type, stamp, subs, tree, ptree, div, iteratee.uid())
    }
  }
  return nostatesproperties
}

exports.element = function (target, type, stamp, subs, tree, ptree, div) {
  ...
  if (nostates) {
    for (let i in nostates) {
      ...
      iteratee.render(void 0, type, stamp, subs, tree, ptree, div, iteratee.uid())
    }
  }
  return nostates
}
