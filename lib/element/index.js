...
function comparestamps (previousState, currentState) {
  ...
  // if (!res) {
  //   console.info('BLOCK ====>', currentState.elem.path, currentState.stamp)
  //   if (currentState.elem.key === 'subtasks') {
  //     console.error('lets get to the bottom of this', currentState)
  //   }
  // } else {
  //   console.warn('  PASS ====>', currentState.elem.path, currentState.stamp)
  // }
  return res
}
        ...
        for (var i = 0, len = data._keys.length; i < len; i++) {
          ...
          if (this[key] === null) {
            ...
            if (this.properties[type].base && this.properties[type].base.render) {
              ...
              // will not fire thats a shame for css etc
