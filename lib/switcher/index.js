  ...
  on:{
    ...
    togetherto: {
      together (params) {
        ...
        if (this._nextElement) {
          this.emit('add', [this._nextElement, this._currentElement, true])
        }
        direction[this._direction](this._currentElement, this, this._duration)
        direction[this._direction](this._nextElement, this, this._duration / 1.5, true)
    ...
    fadeto: {
      fade (params) {
        ...
        this._currentElement.node.style.webkitTransitionDuration = `${this._duration}ms`
        console.log(`${this._duration}ms`)

        this._currentElement.css.set({
          addClass: 'show hide'
        })
