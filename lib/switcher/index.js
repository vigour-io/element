        ...
        if (data) {
          ...
          if (typeof val === 'string') {
            if (val === this.swcurrent) {
              console.warn('switcher: this is wrong, why do I get here')
              return
            }
            console.log('current', this.swcurrent)
            let keys = val.split('.')
            ...
            if (params) {
              ...
              if (swcontent) {
                ...
                if (transition === 'slide') {
                  ...
                  console.info('REMOVE NOW')
                  console.time('remove: ' + swcontent.key)
                  swcontent.remove(event)
                  console.timeEnd('remove: ' + swcontent.key)
                }
              }
              console.time('switcher: ' + val)
