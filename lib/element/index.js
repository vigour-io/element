...
function comparestamps (previousState, currentState) {
  ...
  var res =
   ...
   // pretty heavy check -- this is there for context -- may need to do something else
   // e.g. when resolving removeing somehting
   currentState.elem.uid !== previousState.elem.uid
