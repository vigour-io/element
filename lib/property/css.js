...
var _set = Property.prototype.set
var isDefaultType = require('../element/types')
// var domTypes =
...
exports.properties = {
  css: {
    ...
    render (val, properties, children, rdata) {
      ...
      var key = (parent.key || rdata && rdata.key)
      var type = parent.type
      if (key) {
        val = val ? key + ' ' + val : key
      }
      if (type && type !== parent.node && !isDefaultType.test(type)) {
        val = val ? 'type-' + type + ' ' + val : 'type-' + type
      }
