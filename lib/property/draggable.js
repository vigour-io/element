              ...
              $on: {
                $down: {
                  draggable: [ function draggableDown( event, e ) {
                    var $bind = draggable.$bind ? draggable.$bind._$input.call( this, event, e ) : this
                    var xbind = draggable.$x && draggable.$x._$input
                    var ybind = draggable.$y && draggable.$y._$input
                    ...
                    if( xbind || ybind ) {
                      checkpass = draggable.pass && draggable.pass._$input
                      ex = e.x
                      ey = e.y
