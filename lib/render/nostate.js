'use strict'
exports.property = function (target, type, stamp, subs, tree, ptree, div, renderType) {
  ...
  if (nostatesproperties) {
    for (let i in nostatesproperties) {
      ...
      iteratee.render[renderType].call(iteratee, void 0, type, stamp, subs, tree, ptree, div, iteratee.uid())
    }
  }
  return nostatesproperties
}

exports.element = function (target, type, stamp, subs, tree, ptree, div, renderType) {
