...
var ElemReact = React.createClass({
  render: function () {
    // this.props.children = []
    console.log('update???')
    return React.createElement('div',
    { className: this.props.base.key, children: this.props.children, base: this.props.base })
  }
})
...
exports.define = {
  ...
  node: {
    get: function () {
      ...
      var childNodes
      if (!node) {
        node = React.createElement(ElemReact, { children: [], base:this })
        // node.base = this
        key = this.key
        if (key) {
